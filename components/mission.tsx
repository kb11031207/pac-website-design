    ...
    <section id="mission" className="py-20 md:py-32 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="max-w-3xl mx-auto text-center mb-16">
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-[#3D3D3D] mb-6 text-balance">Our Mission</h2>
          <p className="text-lg md:text-xl text-[#5C5C5C] leading-relaxed text-pretty">
            Our goal is to educate, raise awareness, and foster dialogue within the community about immigrants' right to
            pursue safety, freedom, and opportunity. Through sharing immigrant stories, we ensure they are not only
            heard and valued but deeply and genuinely understood.
          </p>
        </div>
