...
export default function AboutUsSection() {
  ...
  const services = [
    ...
    },
    {
      ...
      description:
        "Unlike massive conferences, PAC creates space for real conversation. Attendees engage directly with speakers, can ask tough questions, and connect with others who care deeply about public affairs.",
      position: "left",
    },
    {
  ...
  const stats = [
    ...
    { icon: <MessageCircle />, value: 2, label: "Days of Thoughtful Conversation.", suffix: "–3" },
      ...
      >
        ...
        >
          <div className="flex-1">
            ...
            <p className="text-white/80">Register for PAC 2026 and be a part of the dialogue.</p>
          </div>
          <Link href="/register">
            <motion.span
